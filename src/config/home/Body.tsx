...
export const configCardWork = [
  ...
  {
    title: 'SHOPPING-CART',
    text: 'Protótico e-commerce Web e Mobile',
    chip: ['ReactJS', 'Docker', 'React Native'],
    image: '/image/shoppig-cart.JPG',
    reposity: 'https://github.com/joao966/cogny-front-end-test',
  },
  {
    title: 'MANAGE USER',
...
export const configWelcome: TypesWelcome[] = [
  ...
  {
    text: 'Software Developer - joaooliveira966@gmail.com',
